...
import { editPet1, editPet2 } from "../api/pet";
...
const EditDogInfo = () => {
  ...
  const editDogInfo = async () => {
    ...
    if (petInfo.selectedImage) {
      editPet1({petInfo, navigate})
    } else {
      editPet2({petInfo, navigate})
    }
  }
    ...
    <div className="edit-dog-info">
      ...
      <div className="main">
        ...
        <div className="input-title-box">
          <div className="input-title dog-img">이미지</div>
          <div className="input-title dog-weight">몸무게</div>
        </div>
        <div className="input-box">
